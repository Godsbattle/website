...
Before following version-specific APIs, inspect the target package's installed
Vitest version and nearby tests. In trackmyprop, those sources outrank this 5.x
reference because packages may run earlier major versions.
