...
name: ui-skills-root
description: >-
  Explicit generic meta-router that selects UI Skills through the ui-skills
  CLI. Use only when the user names it or when a repository has no
  project-specific UI catalyst. Do not invoke inside trackmyprop create-feature.
license: MIT
metadata:
  author: ibelick
  version: "1.0.0"
...
Use it when an agent in Codex or Cursor has a clear UI goal.
